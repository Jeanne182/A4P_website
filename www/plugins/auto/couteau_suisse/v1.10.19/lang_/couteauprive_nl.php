...
// extrait automatiquement de https://trad.spip.net/tradlang_module/couteauprive?lang_cible=nl
...
[[%message_travaux%]][[%titre_travaux%]][[%admin_travaux%]][[-><admin_travaux valeur="1">%avertir_travaux%</admin_travaux>]][[%prive_travaux%]]', # MODIF
	...
	'erreur:jquery' => '{{Note}} : de bibliotheek {jQuery} schijnt inactief op deze pagina. Consulteer:[ici->https://contrib.spip.net/?article2166] de paragraaf op de \'dépendances\' van de plugin of  herlaad deze pagina.', # MODIF
...
Opgelet: in de forums, petities, georganiseerde stromen, enz., het beleid van javascript wordt <b>altijd</b> veilig gesteld.[[%radio_filtrer_javascript3%]]', # MODIF
	...
	'help3' => '<p>Band van documentatie :<br/>• [Le Couteau Suisse->https://contrib.spip.net/?article2166]@contribs@</p><p>Réinitialisatie :
...
Note : les paquets <code>.zip</code> n\'étant pas reconstruits instantanément, il se peut que vous soyez obligé d\'attendre un certain délai avant de pouvoir effectuer la totale mise à jour d\'un plugin tout récemment modifié.', # MODIF
	...
	'outil_intro_old' => 'Deze interface is oud.<br /><br />Als u problemen in het gebruik van <a href=\' ./? exec=admin_couteau_suisse\'> nieuwe interface ondervindt</a>, aarzelt niet aandeel ervan doen over het forum van <a href=\'https://contrib.spip.net/?article2166\'>Spip-Contrib</a>.', # MODIF
