...
' ,
	...
	'cron_html_bg_force' => 'Ne pas lancer le CRON par fsockopen/cURL car la configuration du serveur ne le permet pas (SPIP 3.0.14 mini).',
...
Cet outil peut être couplé avec « [.->sommaire] ».',
	...
	'devdebug:description' => 'Permet de voir les erreurs PHP en clair, et de résoudre parfois certaines mystérieuses pages blanches.<br />Choisissez le niveau d\'erreurs d\'exécution PHP qui seront affichées si le débogueur est actif, ainsi que l\'espace SPIP sur lequel ces réglages s\'appliqueront.',
...
- Version du fichier local : ',
	...
	'erreur:jquery' => '{{Note}} : la librairie {jQuery} semble inactive sur cette page. Veuillez consulter [ici->https://contrib.spip.net/?article2166] le paragraphe sur les dépendances du plugin ou recharger cette page.',
...
Pour définir ce logo, rendez-vous sur la page «<:titre_configuration:>» en cliquant sur le bouton «<:icone_configuration_site:>».',
	...
	'introduction_coupe_descriptif' => 'S\'il existe, ne jamais tronquer le descriptif de l\'objet.',
	'introduction_lien_systematique' => 'Toujours ajouter le lien, même si le texte n\'est pas tronqué.',
...
[[%liens_orphelins%]]',
	...
	'log_gravite' => 'Gravité',
	'log_non' => 'Désactiver totalement les logs',
...
-* Articles : @_ART@.',
	...
	'outil_intro_old' => 'Cette interface est ancienne.<br /><br />Si vous rencontrez des problèmes dans l\'utilisation de la <a href=\'./?exec=admin_couteau_suisse\'>nouvelle interface</a>, n\'hésitez pas à nous en faire part sur le forum de <a href=\'https://contrib.spip.net/?article2166\'>contrib.spip</a>.',
...
@puce@ Configurez les options de journalisation grâce à l\'outil «[.->spip_log]».',
	'req_lentes' => 'Tracer (en logs) les informations correspondant aux requêtes [« trop lentes »->https://dev.mysql.com/doc/refman/5.0/en/slow-query-log.html] <small>(MySQL uniquement, SPIP 2.1.22 et 3.0.9 mini)</small>.',
