...
// extrait automatiquement de https://trad.spip.net/tradlang_module/couteauprive?lang_cible=ca
...
Aquesta eina es pot acompanyar amb « [.->sommaire] ».',
	...
	'detail_jquery3' => '{{Atenció}} : aquesta eina necessita el plugin [jQuery per SPIP 1.92->https://files.spip.net/spip-zone/jquery_192.zip] per funcionar correctament amb aquesta versió d\'SPIP.',
...
[[%message_travaux%]][[%titre_travaux%]][[%admin_travaux%]][[-><admin_travaux valeur="1">%avertir_travaux%</admin_travaux>]][[%prive_travaux%]]', # MODIF
	...
	'erreur:jquery' => '{{Nota}}: la llibreria {jQuery} sembla inactiva en aquesta pàgina. Consulteu [aquí->https://contrib.spip.net/?article2166] el paràgraf sobre les dependències del plugin o recarregar aquesta pàgina.', # MODIF
...
Per forçar la publicació de continguts amagats, n\'hi ha prou afegint el criteri <code>{tout_voir}</code> als bucles de la vostra plantilla.', # MODIF
	...
	'outil_intro_old' => 'Aquesta interfície és antiga.<br /><br />Si trobeu problemes en l\'ús de la <a href=\'./?exec=admin_couteau_suisse\'>nova interfície</a>, no dubteu de dir-nos-ho al fòrum de <a href=\'https://contrib.spip.net/?article2166\'>Spip-Contrib</a>.', # MODIF
