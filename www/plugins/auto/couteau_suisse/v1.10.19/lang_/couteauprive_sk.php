...
// extrait automatiquement de https://trad.spip.net/tradlang_module/couteauprive?lang_cible=sk
...
Tento nástroj môžete spojiť s nástrojom "[zhrnutie.->sommaire]".',
	...
	'detail_jquery3' => '{{N.B.}}: this tool requires the plugin [jQuery pour SPIP 1.92->https://files.spip.net/spip-zone/jquery_192.zip] in order to function correctly with this version of SPIP.',
...
- Verzia lokálneho súboru: ',
	...
	'erreur:jquery' => '{{N.B.}} : {jQuery} does not appear to be active for this page. Please consult the paragraph about the plugin\'s required libraries [in this article->https://contrib.spip.net/?article2166] or reload this page.', # MODIF
...
@puce@ There is a choice of two options for generating the small window which appears on the mouseover. [[%glossaire_js%]][[->%glossaire_abbr%]]', # MODIF
	...
	'help3' => '<p>Odkazy na dokumentáciu:<br/>• [{{Vreckový nožík}}->https://contrib.spip.net/?article2166]@contribs@</p><p>Obnovenie:
...
Pozor! Na to, aby fungoval, tento nástroj potrebuje  zásuvný modul {Zaoblené rohy} typu jQuery. Ak zaškrtnete toto pole, modul Vreckový nožík ho môže nainštalovať automaticky.[[%jcorner_plugin%]]', # MODIF
	...
	'label:long_url' => 'Dĺžka klikateľného opisu:',
...
-* Články: @_ART@.',
	...
	'outil_intro_old' => 'This is the old interface.<br /><br />If you have difficulties in using <a href=\'./?exec=admin_couteau_suisse\'>the new interface</a>, please let us know in the forum of <a href=\'https://contrib.spip.net/?article2166\'>Spip-Contrib</a>.', # MODIF
	...
	'outils_cliquez' => 'Ak chcete zobraziť opis, kliknite na názov príslušného nástroja.',
