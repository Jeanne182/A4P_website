...
// extrait automatiquement de https://trad.spip.net/tradlang_module/couteauprive?lang_cible=gl
...
[[%message_travaux%]][[%titre_travaux%]][[%admin_travaux%]][[-><admin_travaux valeur="1">%avertir_travaux%</admin_travaux>]][[%prive_travaux%]]', # MODIF
	...
	'erreur:jquery' => '{{Nota}} : a libraría {jQuery} parece inactiva nesta páxina. Consulte [aquí->https://contrib.spip.net/?article2166] o parágrafo verbo das dependencias do plugin ou recargar esta páxina.', # MODIF
...
@puce@ Dúas solucións se ofrecen para xerar a pequena xanela automática que aparece cando se sobrevoa á ocorrencia. [[%glossaire_js%]]', # MODIF
	...
	'help3' => '<p>Ligazóns de documentación:<br/>• [A Navalla Suiza->https://contrib.spip.net/?article2166]@contribs@</p><p>Reinicios:
