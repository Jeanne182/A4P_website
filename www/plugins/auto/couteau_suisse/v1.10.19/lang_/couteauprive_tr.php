...
// extrait automatiquement de https://trad.spip.net/tradlang_module/couteauprive?lang_cible=tr
...
[[%message_travaux%]][[%titre_travaux%]][[%admin_travaux%]]', # MODIF
	...
	'erreur:jquery' => '{{Not}} : {jQuery} kütüphanesi bu sayfada pasif durumda görülüyor. Eklentinin bağımlılıkları paragrafına bakınız [->https://contrib.spip.net/?article2166].', # MODIF
...
@puce@ Deux solutions vous sont offertes pour générer la petite fenêtre automatique qui apparaît lors du survol de la souris. [[%glossaire_js%]]', # MODIF
	...
	'help3' => 'Belgelendirme bağlantıları :<br/>• [İsviçre Çakısı->https://contrib.spip.net/?article2166]@contribs@</p><p>Yeniden başlatılması :
