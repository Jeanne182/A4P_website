...
// extrait automatiquement de https://trad.spip.net/tradlang_module/couteauprive?lang_cible=ast
...
[[%message_travaux%]][[%titre_travaux%]][[%admin_travaux%]][[%prive_travaux%]]', # MODIF
	...
	'erreur:jquery' => '{{Nota}}: la biblioteca {jQuery} paez inactiva nesta páxina. Has de consultar [equí->https://contrib.spip.net/?article2166] el párrafu so les dependencies del plugin o recargar esta páxina.', # MODIF
...
@puce@ Ufrense dos soluciones pa xenerar el ventanucu automáticu que apaez cuando pases el mur enriba la pallabra. [[%glossaire_js%]]', # MODIF
	...
	'help3' => '<p>Enllaces de documentación :<br/>• [La Navaya Suiza->https://contrib.spip.net/?article2166]@contribs@</p><p>Reentamos:
...
[[%liens_orphelins%]]', # MODIF
	...
	'outil_intro_old' => 'Esta interfaz ye antigua.<br /><br />Si alcuentres problemes cola utilización de la <a href=\'./?exec=admin_couteau_suisse\'>interfaz nueva</a>, afalámoste a comentánoslo nel foru de <a href=\'https://contrib.spip.net/?article2166\'>Spip-Contrib</a>.', # MODIF
