...
// extrait automatiquement de https://trad.spip.net/tradlang_module/couteau?lang_cible=fr_tu
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// E
	'email_forum' => 'Merci de spécifier ton email !',
	'explique_spam' => 'Attention : tu as utilisé des balises, des caractères ou des mots interdits.<br /><br />Reviens en arrière !',
	...
	// N
	'nom_email_forum' => 'Merci de spécifier ton nom ou ton email !',
	'nom_forum' => 'Merci de spécifier ton nom !',
	...
	'objet_mot' => 'Mot',
	'objet_mots' => 'Mots',
	'objet_petition' => 'Pétition',
	'objet_petitions' => 'Pétitions',
	...
	// P
	'page_debut' => 'Première page',
	'page_fin' => 'Dernière page',
...
N’hésite pas à consulter les articles de documentation du plugin publiés sur : [contrib.spip.net->https://contrib.spip.net/Le-Couteau-Suisse].
...
Compatibilité : SPIP v1.92x, v2.x.x et v3.0', # MODIF
	...
	'pp_chatons_inserer_drop' => 'Insérer un chaton dans votre texte',
	...
	'pp_decoration_inserer' => 'Décoration « @balise@.@racc@ »',
	'pp_decoration_inserer_drop' => 'Appliquer au texte une « décoration » personnalisée',
	'pp_decoupe_onglets' => 'Insérer un système d’onglet',
	'pp_decoupe_separateur' => 'Insérer un séparateur de page ou d’onglet',
	'pp_filets_inserer' => 'Insérer un filet de style « @filet@ »',
	'pp_filets_inserer_drop' => 'Insérer un filet de séparation',
	'pp_smileys_inserer' => 'Insérer une frimousse @smiley@',
	...
	'stats_date' => '@jour@/@mois@/@annee@ à @h@h@m@',

	// T
	'test_base' => 'Test de la base de données',
	...
	'urls_propres_objet' => 'Sont listées ici les URLs propres stockées en base grâce auxquelles les visiteurs pourront naviguer sur ton site.',
	'urls_propres_titre' => 'URLS PROPRES',

	// V
	'variable_vide' => '(Vide)',
	'visiteurs_connectes' => 'Visiteurs connectés : @nb@',
