...
// extrait automatiquement de https://trad.spip.net/tradlang_module/couteauprive?lang_cible=es
...
Esta herramienta puede acoplarse con « [.->sommaire] ».', # MODIF
	...
	'erreur:jquery' => '{{Nota}}: la biblioteca {jQuery} parece estar inactiva para esta página. Consulta [aquí->https://contrib.spip.net//La-navaja-suiza] el párrafo sobre las dependencias del plugin, o recarga esta página.', # MODIF
...
@puce@ Se ofrecerán dos soluciones para generar la pequeña ventana automática que aparece al pasar el ratón por encima. [[%glossaire_js%]]', # MODIF
	...
	'help3' => '<p>Enlaces a documentación:<br/>• [La Navaja Suisza->https://contrib.spip.net/La-navaja-suiza]@contribs@</p><p>Reinicializaciones:
