...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'autoriser_admin_restreint' => 'Autoriser les administrateur·trices restreint·e·s à créer et modifier les formulaires',
	'autoriser_admin_restreint_explication' => 'Par défaut, seul·es les administrateurs et administratrices ont accès à la création et modification des formulaires',
	...
	'editer_message_ok_explication' => 'Vous pouvez personnaliser le message qui sera affiché à l’internaute après l’envoi d’un formulaire valide. Il est possible d’afficher la valeur de certains champs soumis en utilisant  @raccourci@.',
	...
	'identification_par_id_reponse' => 'Par l’identifiant (id_formulaire_reponse) de la réponse, passé explicitement lors de l’appel au formulaire dans un squelette',
	...
	'traiter_email_option_activer_ip_label_case' => 'Envoyer l’adresse IP de l’expediteur·trice aux destinataires.',
	...
	'traiter_email_option_courriel_envoyeur_accuse_label' => 'Courriel de l’expéditeur·trice de l’accusé de réception',
	...
	<br />- Pour envoyer à un·e auteur·trice du site, utiliser l’option « Destinataire » (plus haut).
...
',
	...
	'traiter_email_option_envoyeur_courriel_label' => 'Courriel de l’expediteur·trice',
	...
	'traiter_email_option_nom_envoyeur_accuse_explication' => 'Précisez le nom de l’expéditeur·trice utilisé pour envoyer l’accusé de réception. Si vous ne mettez rien, ce sera le nom du site..',
	'traiter_email_option_nom_envoyeur_accuse_label' => 'Nom de l’expéditeur·trice de l’accusé de réception',
	'traiter_email_option_pj_explication' => 'Si les documents postés sont suffisament légers (la taille maximale est modifiable par le·la webmestre à travers la constante _FORMIDABLE_TAILLE_MAX_FICHIERS_EMAIL).',
	...
	'traiter_enregistrement_option_auteur' => 'Utiliser les auteur·trices pour les formulaires',
	'traiter_enregistrement_option_auteur_explication' => 'Attribuer un·e ou plusieurs auteur·trices à un formulaire. Si cette option est activée, seul·es les auteur·trices d’un formulaire pourront accéder à leurs données.',
	...
	'traiter_enregistrement_option_modifiable_explication' => 'Modifiable : les internautes peuvent modifier leurs réponses après coup.',
