...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// O
	'option_aff_art_interface_explication' => 'Mostra unicamente gli articoli della lingua dell’utente', # MODIF
	...
	'option_aff_rub_interface_explication' => 'Mostra unicamente le rubriche della lingua dell’utente', # MODIF
	...
	'option_choix_destinataires_explication' => 'Uno o più autori tra i quali l’utente potrà fare una scelta. Se non si seleziona niente, è l’autore che ha installato il sito che sarà scelto.', # MODIF
	...
	'option_info_obligatoire_explication' => 'Puoi modificare l’indicazione predefinita per i campi obbligatori : <i>[Obbligatorio]</i>.', # MODIF
	...
	'option_maxlength_explication' => 'L’utente non può digiatare più caratteri del numero qui indicato.', # MODIF
	'option_maxlength_label' => 'Numero massimo di caratteri',
	'option_multiple_explication' => 'L’utente può selezionare più valori', # MODIF
	...
	'option_type_choix_plusieurs' => 'Consenti all’utente di scegliere <strong>più</strong> destinatari.', # MODIF
	'option_type_choix_tous' => 'Imposta <strong>tutti</strong> questi autori come destinatari. L’utente non avrà alcuna scelta.', # MODIF
	...
	// S
	'saisie_auteurs_explication' => 'Consente di selezionare uno o più autori', # MODIF
	...
	'saisie_date_explication' => 'Consente di inserire una data con l’aiuto di un calendario', # MODIF
	'saisie_date_titre' => 'Data',
	'saisie_destinataires_explication' => 'Consente di scegliere uno o più destinatari tra gli autore selezionati.', # MODIF
	...
	'saisie_hidden_explication' => 'Un campo preimpostato che l’utente non potrà vedere.', # MODIF
	...
	'saisie_radio_explication' => 'Consente di scegliere un’opzione tra più disponibili.', # MODIF
