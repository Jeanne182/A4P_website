...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'form_pet_aucune_signature' => 'Asnjë regjistrim nuk përkon me këtë kod...', # MODIF
	'form_pet_confirmation' => 'Ju lutem konfirmoni pjesëmarrjen tuaj:',
	'form_pet_deja_signe' => 'Ju e keni firmosur një herë këtë tekst.',
	'form_pet_envoi_mail_confirmation' => 'Sapo ju derguam një mesazh e-mail. Duhet ta lexoni dhe të hapni faqen që gjendet ne atë mesazh në menyrë që të konfirmoni pjesëmarrjen tuaj.', # MODIF
	'form_pet_mail_confirmation' => 'Tungjatjeta,

Ju keni kërkuar të firmosni peticionin me titull:
@titre@.

Informacionet e dhëna nga ju janë:
    Emri: @nom_email@
    Faqja: @nom_site@ - @url_site@

VINI RE...
Që firma juaj të pranohet,
duhet të hapni faqen që gjendet
poshtë këtij teksti:
    @url@
