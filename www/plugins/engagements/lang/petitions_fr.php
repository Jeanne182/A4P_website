...
Vous avez demandé à vous engager pour : @titre@.

Vous avez fourni les informations suivantes :
	Nom : @prenom_email@ @nom_email@
	Année de promotion : @annee_naissance@
	Ecole : @id_ecole@
	Pays de l'école : @pays_alumni@
	Linkedin : @linkedin@
	Nom de l'entreprise/organisation : @organisation@
	Fonction occupée au sein de l'entreprise/organisation : @fonction_organisation@
	Ville de résidence : @ville_organisation@
	Code postal : @code_postal@
	Pays de résidence : @pays_organisation@
	
    @message@

	Autorisation de publier les informations sur le site des Alumni for the Planet : @autorisation_infos_publiques@

IMPORTANT...
Pour valider votre signature, il suffit de vous connecter à l’adresse ci-dessous (dans le cas contraire, votre demande sera rejetée) :
...
",
	...
	'form_pet_votre_prenom' => 'Votre prénom',
	'form_pet_votre_annee_naissance' => 'Votre année de naissance',
	'form_pet_votre_annee_promotion' => 'Votre année de promotion',

	'form_pet_votre_ecole_alumni' => "Votre école",
	'form_pet_pays_ecole' => 'Pays de votre école',
	...
	'info_annee_naissance' => 'ANNEE DE NAISSANCE :',
	'info_annee_promotion' => 'ANNEE DE PROMOTION:',
	'info_ecole_alumni' => 'ECOLE :',
	'info_pays_alumni' => "PAYS DE L'ECOLE :",
	...
	'signatures_recherche_label' => 'Rechercher des signataires :',
	...
	'titre_petition' => "Je m'engage maintenant !",
