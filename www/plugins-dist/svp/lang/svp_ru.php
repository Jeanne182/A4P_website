...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'bulle_aller_demonstration' => 'Перейти к странице демонстрации',
	...
	'bulle_telecharger_fichier_depot' => 'Добавить XML файл репозитория',
	...
	'config_activer_pas_a_pas_explication' => 'Данная опция позволяет выполнять операции с плагинами не в пакетном режиме (когда сразу выполняется несколько операций), а пошагово, подтверждая каждую операцию.',
	'config_activer_runtime' => 'Включить режим совместимости?',
	'config_activer_runtime_explication' => 'Если режим совместимости включен, то будут показываться только плагины совместимые с текущей версией SPIP. Если режим совместимости выключен, то будут показываться все плагины вне зависимости от текущей версии.',
	...
	'config_depot_editable_explication' => 'Возможность редактировать информацию о репозитории. Такой потребности не должно у вас возникнуть, поэтому оставьте эту опцию выключенной.',
	'confirmer_desinstaller' => 'Внимание: деинсталляция плагина <b>удаляет</b> его базу данных и является необратимой. <br /> Если вы не уверены, просто отключите плагин.',
...
Вам необходимо подтвердить выполнение этой операции.
	...
	'erreur_auth_plugins_ajouter_lib' => 'Недостаточно прав для того, чтобы установить библиотеку.',
	'erreur_dir_dib_ecriture' => 'Отсутствуют права на запись папки @dir@. Невозможно загрузить библиотеку!',
	...
	'erreurs_xml' => 'Невозможно прочитать некоторые XML описания',
...
Если вы хотите отключить плагин - свяжитесь с разработчиками сайта или проконсультируйтесь в  <a href="http://programmer.spip.org/repertoire_plugins_dist">документации</a>.', # MODIF
	...
	'info_tri_score' => 'сортировать по релевантности',
	...
	'lien_demo' => 'Демонстрация',
	'lien_documentation' => 'Документация',
	...
	'message_action_finale_kill_ok' => 'Файлы плагина «@plugin@» (версия : @version@) успешно удалены',
	'message_action_finale_off_fail' => 'Не удалось отключить плагин «@plugin@» (версия: @version@) ',
	'message_action_finale_off_ok' => 'Плагин «@plugin@» (version: @version@) успешно отключён',
	'message_action_finale_on_fail' => 'Не удалось включить плагин «@plugin@» (версия: @version@) ',
	'message_action_finale_on_ok' => 'Плагин «@plugin@» (версия: @version@) включён ',
	'message_action_finale_stop_fail' => 'Не удалось удалить плагин «@plugin@» (версия: @version@)',
	'message_action_finale_stop_ok' => 'Плагин «@plugin@» (версия: @version@) успешно удалён',
	...
	'message_action_finale_upon_ok' => 'Плагин «@plugin@» успешно обновлён с версии  @version@ до @version_maj@ и включён',
	...
	'message_action_kill' => 'Удалить файлы из плагина «@plugin@» (версия: @version@)',
	...
	'message_nok_url_archive' => 'URL-адрес в архиве недействителен',
