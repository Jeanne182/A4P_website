...
// extrait automatiquement de https://trad.spip.net/tradlang_module/dump?lang_cible=lb
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'erreur_table_absente' => 'D’Tafel @table@ feelt',
	...
	'info_sauvegarde_reussi_03' => 'zeréck bei d’Gestioun',
	...
	'selectionnez_table_a_restaurer' => 'Wielt d’Tafelen aus déi sollen zeréckgespillt ginn',

	// T
	'texte_admin_tech_01' => 'Dës Optioun erlaabt den Inhalt vun der Datebank am Dossier @dossier@ ze späicheren. Vergiesst net och de ganzen Inhalt vum Dossier @img@ erofzelueden, wou d’Biller an d’Dokumenter vun den Artikelen an de Rubrike sinn.',
	...
	'texte_restaurer_sauvegarde' => 'Dës Fonctioun erlaabt d’Zeréckspillen vun engem Backup vun der Datebank. Duerfir muss de Backup-Fichier am Dossier @dossier@ sinn. Passt op mat dëser Prozedur: <b>d’Ännerungen kënne net réckgängeg gemaach ginn.</b>',
	'texte_sauvegarde' => 'E Backup vun der Datebank maachen',
	'texte_sauvegarde_base' => 'Backup vun der Datebank maachen',
	'tout_restaurer' => 'All d’Tafelen zeréckspillen',
