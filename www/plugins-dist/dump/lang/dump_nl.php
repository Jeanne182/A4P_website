...
// extrait automatiquement de https://trad.spip.net/tradlang_module/dump?lang_cible=nl
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// B
	'bouton_restaurer_base' => 'De database herstellen',
	...
	'erreur_taille_sauvegarde' => 'De backup blijkt te zijn mislukt. Het bestand @fichier@ is leeg of afwezig.',

	// I
	'info_aucune_sauvegarde_trouvee' => 'Geen backup gevonden',
	'info_restauration_finie' => 'Het is klaar!. Da backup @archive@ werd op je site teruggezet. Je kan ',
	...
	'info_sauvegarde_reussi_04' => 'van jouw website.',
	...
	'selectionnez_table_a_restaurer' => 'Selecteer de terug te zetten tabellen',

	// T
	'texte_admin_tech_01' => 'Deze optie laat je toe de inhoud van de database op te slaan in een bestand dat bewaard zal worden in de map @dossier@. Vergeet ook niet de volledige map @img@ te bewaren. Zij bevat alle afbeeldingen en bijlagen bij de artikelen en rubrieken.',
	'texte_admin_tech_02' => 'Waarschuwing: deze backup kan UITSLUITEND op een website worden teruggezet die onder dezelfde versie van SPIP is geïnstalleerd. Je moet vooral niet «de database ledigen» in de hoop de backup terug te kunnen zetten na het updaten van SPIP… Raadpleeg <a href= "@spipnet@">de documentatie van SPIP</a>.',
	'texte_restaurer_base' => 'De inhoud van de reservekopie van de database terugzetten',
	'texte_restaurer_sauvegarde' => 'Deze optie laat je toe een eerder genomen reservekopie van de database terug te plaatsen. Hiertoe dien je het bestand met de reservekopie te plaatsen in de map @dossier@.
 Wees voorzichtig met het gebruik van deze optie: <b>wijzigingen gaan verloren en de handeling is onomkeerbaar.</b>',
	'texte_sauvegarde' => 'Een reservekopie maken van de inhoud van de database',
	'texte_sauvegarde_base' => 'Reservekopie maken van de database',
