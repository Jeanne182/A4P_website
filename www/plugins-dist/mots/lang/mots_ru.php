...
// extrait automatiquement de https://trad.spip.net/tradlang_module/mots?lang_cible=ru
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// C
	'creer_et_associer_un_mot' => 'Создать и добавить ключ',

	// I
	'icone_creation_groupe_mots' => 'Новая группа ключей',
	'icone_creation_mots_cles' => 'Новый ключ',
	'icone_modif_groupe_mots' => 'Изменить группу ключей',
	'icone_modifier_mot' => 'Изменить ключ',
	'icone_mots_cles' => 'Ключи',
	'icone_supprimer_groupe_mots' => 'Удалить группу',
	'icone_voir_groupe_mots' => 'Просмотр группы',
	'icone_voir_tous_mots_cles' => 'Показать все ключи',
	'info_1_groupe_mots' => '1 группа ключей',
	'info_articles_lies_mot' => 'Статьи с ключом',
	'info_aucun_groupe_mots' => 'Нет групп ключей',
	'info_aucun_mot_cle' => 'Нет ключей',
	...
	'item_non_ajout_mots_cles' => 'Отключить добавление ключей к комментариям на сайте',
	'item_non_utiliser_config_groupe_mots_cles' => 'Отключить настройку групп ключей',
	'item_non_utiliser_mots_cles' => 'Отключить ключи и группы ключей',
	'item_utiliser_config_groupe_mots_cles' => 'Включить настройку групп ключей',
	'item_utiliser_mots_cles' => 'Включить ключи и группы ключей',

	// L
	'lien_ajouter_mot' => 'Добавить ключ',
	'logo_groupe' => 'ЛОГОТИП ГРУППЫ',
