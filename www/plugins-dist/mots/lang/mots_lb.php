...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'bouton_checkbox_qui_attribue_mot_cle_visiteurs' => 'd’Visiteure vum Site, wann se e Message an de Forum schécken.',
	...
	'info_creation_mots_cles' => 'Fléckt hei d’Schlësselwierder vum Site bäi a stellt se an',
	'info_dans_groupe' => 'Am Grupp:',
	'info_delet_mots_cles' => 'Dir wëllt d’Schlësselwuert <b>@titre_mot@</b> (@type_mot@) läschen. Dëst Wuert ass un <b>@texte_lie@</b> gebonnen, dir musst dës Decisioun bestätegen:',
	'info_groupe_important' => 'Wichtege Grupp',
	'info_modifier_mot' => 'Schlësselwuert änneren:',
	'info_mots_cles' => 'D’Schlësselwierder',
	'info_mots_cles_association' => 'D’Schlësselwierder vun dësem Grupp kënnen verbonne ginn:',
	...
	'info_qui_attribue_mot_cle' => 'D’Schlësselwierder vun dësem Grupp kënne verdeelt gi vun:',
	...
	'item_non_ajout_mots_cles' => 'D’Schlësselwierder an de Forume verbidden',
	...
	'texte_mots_cles' => 'D’Schlësselwierder erlaben thematesch Linken tëschent Artikelen ze maachen, egal a wéi enger Rubrik se sinn. Dir kënnt esou är Navigatioun vum Site erweideren, oder dëst benotzen fir de Layout vun den Artikelen an de Skeletter unzepassen.',
	'texte_mots_cles_dans_forum' => 'Wëllt dir erlaben dat d’Visiteure vum Site an den ëffentleche Forumen Schlësselwierder kënnen auswielen? (Opgepasst: dës Fonctioun ass zimlech schwéier richteg ze benotzen.)',
