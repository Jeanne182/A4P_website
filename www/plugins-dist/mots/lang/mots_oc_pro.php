...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// A
	'avis_conseil_selection_mot_cle' => '<b>Groupe important :</b> il est fortement conseillé de sélectionner un mot-clé dans ce groupe.', # NEW
	'avis_doublon_mot_cle' => 'Un mot existe deja avec ce titre. Êtes vous sûr de vouloir créer le même ?', # NEW

	// B
	'bouton_checkbox_qui_attribue_mot_cle_administrateurs' => 'les administrateurs du site', # NEW
	'bouton_checkbox_qui_attribue_mot_cle_redacteurs' => 'les rédacteurs', # NEW
	...
	// I
	'icone_creation_groupe_mots' => 'Créer un nouveau groupe de mots', # NEW
	'icone_creation_mots_cles' => 'Créer un nouveau mot-clé', # NEW
	'icone_modif_groupe_mots' => 'Modifier ce groupe de mots', # NEW
	'icone_modifier_mot' => 'Modifier ce mot-clé', # NEW
	'icone_mots_cles' => 'Mots-clés', # NEW
	'icone_supprimer_groupe_mots' => 'Supprimer ce groupe', # NEW
	'icone_voir_groupe_mots' => 'Voir ce groupe de mots', # NEW
	'icone_voir_tous_mots_cles' => 'Voir tous les mots-clés', # NEW
	'info_1_groupe_mots' => '1 groupe de mots', # NEW
	'info_articles_lies_mot' => 'Les articles liés à ce mot-clé', # NEW
	'info_aucun_groupe_mots' => 'Aucun groupe de mots', # NEW
	'info_aucun_mot_cle' => 'Aucun mot-clé', # NEW
	'info_changer_nom_groupe' => 'Changer le nom de ce groupe :', # NEW
	'info_creation_mots_cles' => 'Créez et configurez ici les mots-clés du site', # NEW
	'info_dans_groupe' => 'Dans le groupe :', # NEW
...
<b>@texte_lie@</b> vous devez confirmer cette décision :', # NEW
	'info_groupe_important' => 'Groupe important', # NEW
	...
	'info_retirer_mot' => 'Retirer ce mot', # NEW
	'info_retirer_mots' => 'Retirer tous les mots', # NEW
