...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'bouton_radio_publication_immediate' => 'Publicación inmediata de los mensajes (las contribuciones aparecen en cuanto son enviadas, siendo posible eliminarlas después).',

	// D
	'documents_interdits_forum' => 'Documentos prohibidos en el foro',

	// E
	'erreur_enregistrement_message' => 'No se ha podido guardar su mensaje debido a un problema técnico ',
	'extensions_autorisees' => 'Extensiones autorizadas:',
	'extensions_autorisees_toutes' => 'todas',

	// F
	'form_pet_message_commentaire' => '¿Un mensaje, un comentario?',
	'forum' => 'Foro',
	'forum_acces_refuse' => 'Ya no tiene acceso a estos foros.',
	'forum_attention_dix_caracteres' => '<b>¡Atención!</b> su mensaje debe tener al menos diez caracteres.',
	'forum_attention_message_non_poste' => '¡Atención! Aún no ha publicado su mensaje',
	'forum_attention_nb_caracteres_mini' => '<b>¡Atención!</b> su mensaje debe tener al menos @min@ caracteres.',
	'forum_attention_trois_caracteres' => '<b>¡Atención!</b> el título debe tener al menos tres caracteres.',
	'forum_attention_trop_caracteres' => '<b>¡Atención!</b> el mensaje es demasiado largo (@compte@ caracteres) para poder guardarse, no debe sobrepasar los @max@ caracteres.',
	'forum_avez_selectionne' => 'Ha seleccionado:',
	'forum_cliquer_retour' => 'Haga clic <a href=\'@retour_forum@\'>aquí</a> para continuar.',
	'forum_envoyer' => 'Enviar',
	'forum_forum' => 'foro',
	'forum_info_modere' => 'Este foro es moderado a priori: su contribución sólo aparecerá una vez validada por un/a administrador/a del sitio.',
	'forum_lien_hyper' => 'Enlace hipertexto',
	'forum_message' => 'Su mensaje',
	'forum_message_definitif' => 'Mensaje definitivo: enviar al sitio',
	'forum_message_trop_long' => 'Su mensaje es demasiado largo. Sólo se admite un máximo de 20.000 caracteres.',
	'forum_ne_repondez_pas' => 'No conteste a este correo, sino al foro en la siguiente dirección:',
	'forum_page_url' => '(Si su mensaje se refiere a un artículo publicado en Internet, o a una página que contiene más informaciones, indique a continuación el título de la página y su dirección URL)',
	...
	'forum_qui_etes_vous' => '¿Quién es usted?',
	'forum_saisie_texte_info' => 'Este formulario acepta atajos SPIP <code>[-&gt;url] {{negrita}} {cursiva} &lt;quote&gt; &lt;code&gt;</code> código HTML <code>&lt;q&gt; &lt;del&gt; &lt;ins&gt;</code>. Para separar párrafos, simplemente deje líneas vacías.',
	'forum_texte' => 'Texto de su mensaje',
	'forum_titre' => 'Título',
	'forum_url' => 'Su sitio web',
	'forum_valider' => 'Validar la elección',
	'forum_voir_avant' => 'Previsualización',
	'forum_votre_email' => 'Su dirección de correo electrónico',
	'forum_votre_nom' => 'Su nombre',
	'forum_vous_enregistrer' => 'Para participar en este foro, debe registrarte previamente.
Gracias por indicar a continuación el identificador personal que se le ha
suministrado. Si no está inscrito/a, debe',
	...
	'icone_supprimer_message' => 'Eliminar este mensaje',
	'icone_supprimer_messages' => 'Eliminar estos mensajes',
	'icone_valider_message' => 'Validar este mensaje',
	'icone_valider_messages' => 'Validar estos mensajes ',
	'icone_valider_repondre_message' => 'Confirmar y reponder a este mensaje',
	'info_1_message_forum' => '1 mensaje de foro',
	'info_activer_forum_public' => 'Para activar los foros públicos, seleccione el modo de moderación por defecto:',
	'info_appliquer_choix_moderation' => 'Aplicar este tipo de moderación',
	'info_config_forums_prive' => 'En el espacio privado del sitio, puede activar varios tipos de foro:',
	...
	'info_desactiver_forum_public' => 'Desactivar los foros públicos. Podrán ser activados puntualmente para los artículos, pero no para los breves, las secciones, etc.',
	'info_envoi_forum' => 'Seguimiento de los foros',
	'info_fonctionnement_forum' => 'Funcionamiento del foro:',
	'info_forcer_previsualisation_court' => 'Forzar la vista previa',
	'info_forcer_previsualisation_long' => 'Forzar la vista previa antes de mandar el mensaje',
	'info_forums_liees_mot' => 'Los mensajes de foro ligados a esta palabra',
	'info_gauche_suivi_forum_2' => 'La página de <i>seguimiento de los foros</i> es una herramienta de gestión de su sitio (y no un espacio de diálogo o de redacción). Muestra todas las contribuciones a los foros del sitio, tanto en público como en el espacio privado, y permite gestionarlas.',
	...
	'info_option_email' => 'Cuando se envía una nueva contribución a un foro asociado a un artículo, los autores del artículo pueden recibir una notificación por correo electrónico. Indique para cada tipo de foro si hay que utilizar esta opción.',
	'info_pas_de_forum' => 'sin foro',
	'info_question_visiteur_ajout_document_forum' => 'Si desea autorizar la publicación de documentos (imágenes, sonidos...) en los mensajes de foro, indique la lista de extensiones de documentos autorizados en los foros (por ejemplo: gif, jpg, png, mp3).',
	...
	'lien_reponse_breve_2' => 'Respuesta al breve',
	...
	// R
	'repondre_message' => 'Responder a este mensaje',
	...
	// T
	'text_article_propose_publication_forum' => 'No dude en dar su opinión mediante el foro adjunto a este artículo (en la parte inferior de la página).',
	'texte_en_cours_validation' => 'Los siguientes artículos, breves y foros están propuestos para publicación.',
	'texte_en_cours_validation_forum' => 'No dude en dar su opinión mediante los foros adjuntos.',
	...
	'titre_forum' => 'Foros',
	'titre_forum_suivi' => 'Seguimiento de los foros',
