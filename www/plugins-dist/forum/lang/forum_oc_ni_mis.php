...
// extrait automatiquement de https://trad.spip.net/tradlang_module/forum?lang_cible=oc_ni_mis
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// A
	'aucun_message_forum' => 'Mìnga message de fòrou',
	...
	'extensions_autorisees_toutes' => 'touti',

	// F
	'form_pet_message_commentaire' => 'Un message, un coumentari ?',
	'forum' => 'Fòrou',
	'forum_acces_refuse' => 'Poudès plus achèdre en aquelu fòrou.',
	'forum_attention_dix_caracteres' => '<b>Mèfi !</b> lou vouòstre message dèu avé au màncou dès caracter.',
	'forum_attention_message_non_poste' => 'Mèfi, noun avès poustat lou vouòstre message !',
	'forum_attention_nb_caracteres_mini' => '<b>Mèfi !</b> lou vouòstre message dèu countenì au màncou @min@ caracter.',
	'forum_attention_trois_caracteres' => '<b>Mèfi !</b> lou vouòstre titre dèu avé au màncou tré caracter.',
	'forum_attention_trop_caracteres' => '<b>Mèfi !</b> lou vouòstre message es tròu lonc (@compte@ caracter) per si poudé registrà, noun cau escoumpassà @max@ caracter.',
	'forum_avez_selectionne' => 'Avès seleciounat :',
	'forum_cliquer_retour' => 'Clicas <a href=\'@retour_forum@\'>aquì</a> per countinuà.',
	'forum_envoyer' => 'Mandà',
	'forum_forum' => 'fòrou',
	...
	'forum_message_trop_long' => 'Lou vouòstre message es tròu lonc. La talha massimala es de 20 000 caracter.',
	'forum_ne_repondez_pas' => 'Noun respoundès en aquel e-mail mà sus lou fòrou a l’adressa seguenta :',
	'forum_page_url' => '(se lou vouòstre message si referisse a un article publicat sus lou web, o a una pàgina que fournisse mai d’infourmacioun, poudès endicà aquì souta lou titre de la pàgina e la sieu adressa.)',
	'forum_permalink' => 'Estac permanent vers lou coumentari',
	'forum_poste_par' => 'Message poustat @parauteur@ a la seguida de l’article « @titre@ ».',
	...
	'forum_saisie_texte_info' => 'Aqueu fourmulari acheta li escourcha SPIP <code>[-&gt;url] {{gras}} {italique} &lt;quote&gt; &lt;code&gt;</code> e lou code HTML <code>&lt;q&gt; &lt;del&gt; &lt;ins&gt;</code>. Per creà lu paràgrafou, laissas simplamen de ligna vuèii.',
 ...
 de mouderacioun predefinit :',
	...
	'info_option_email' => 'Coura un visitaire dóu sit pouòsta un message nouvèu en lou fòrou assouciat a un article, lu autour de l’article pouòdon estre prevengut d’aqueu message da e-mail. Endicas per cada tìpou de fòrou se si cau utilisà aquela oupcioun.',
	'info_pas_de_forum' => 'mìnga fòrou',
	'info_question_visiteur_ajout_document_forum' => 'Se voulès autourisà lu visitaire a jougne de doucumen (image, soun…) dau siéu message de fòrou, endicas aquì souta la lista dei estensioun de doucumen autourisat per lu fòrou (ex : gif, jpg, png, mp3).',
	'info_question_visiteur_ajout_document_forum_format' => 'Se voulès autourisà toui lu tìpou de doucumen counsiderat couma segur da SPIP, metès una stela. Per ren autourisà, endicas ren.',
	...
	'item_activer_forum_administrateur' => 'Ativà lou fòrou dei aministratour',
	'item_config_forums_prive_global' => 'Ativà lou fòrou dei redatour',
	'item_config_forums_prive_objets' => 'Ativà aquelu fòrou',
	'item_desactiver_forum_administrateur' => 'Desativà lou fòrou dei aministratour',
	'item_non_config_forums_prive_global' => 'Desativà lou fòrou dei redatour',
	'item_non_config_forums_prive_objets' => 'Desativà aquelu fòrou',

	// L
	'label_selectionner' => 'Seleciounà :',
	'lien_reponse_article' => 'Respouòsta a l’article',
	'lien_reponse_breve_2' => 'Respouòsta a la brèva',
	'lien_reponse_message' => 'Respouòsta au message',
	'lien_reponse_rubrique' => 'Respouòsta a la rùbrica',
	'lien_reponse_site_reference' => 'Respouòsta au sit referençat',
	'lien_vider_selection' => 'Vuà la selecioun',

	// M
	'messages_aucun' => 'Mìnga',
	'messages_meme_auteur' => 'Toui lu message d’aquel autour',
	'messages_meme_email' => 'Toui lu message d’aquel e-mail',
	'messages_meme_ip' => 'Toui lu message d’aquela IP',
	'messages_off' => 'Suprimat',
	'messages_perso' => 'Persounal',
	'messages_privadm' => 'Aministratour',
	'messages_prive' => 'Privat',
	'messages_privoff' => 'Suprimat',
	'messages_privrac' => 'General',
	'messages_prop' => 'Proupausat',
	'messages_publie' => 'Publicat',
	'messages_spam' => 'Spam',
	'messages_tous' => 'Toui',
	...
	// S
	'statut_off' => 'Suprimat',
	'statut_original' => 'ouriginal',
	'statut_prop' => 'Proupausat',
	'statut_publie' => 'Publicat',
	'statut_spam' => 'Spam',

	// T
	'text_article_propose_publication_forum' => 'Noun esitas de dounà lou vouòstre avis gauch au fòrou atacat en aquel article (davau de la pàgina).',
	'texte_en_cours_validation' => 'Lu article, brèva, fòrou aquì souta soun proupausat a la publicacioun.',
	'texte_en_cours_validation_forum' => 'Noun esitas de dounà lou vouòstre avis gauch ai fòrou que lì soun atacat.',
	...
	'titre_forum' => 'Fòrou',
	'titre_forum_suivi' => 'Segut dei fòrou',
	'titre_page_forum_suivi' => 'Segut dei fòrou',
	'titre_selection_action' => 'Selecioun',
	'tout_voir' => 'Veire toui lu message',

	// V
	'voir_messages_objet' => 'veire lu message'
);
