...
// extrait automatiquement de https://trad.spip.net/tradlang_module/forum?lang_cible=fr_fem
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'bouton_radio_enregistrement_obligatoire' => 'Enregistrement obligatoire (les utilisatrices doivent s’abonner en fournissant leur adresse email avant de pouvoir poster des contributions).',
	...
	(les contributions s’affichent dès leur envoi, les administratrices peuvent
	...
	'forum_forum' => 'forum',
	'forum_info_modere' => 'Ce forum est modéré a priori : votre contribution n’apparaîtra qu’après avoir été validée par une administratrice du site.',
	...
	'forum_vous_enregistrer' => 'Pour participer à
		...
		été fourni. Si vous n’êtes pas enregistrée, vous devez',
	...
	'info_config_forums_prive_admin' => 'Un forum réservé aux administratrices du site :',
	'info_config_forums_prive_global' => 'Un forum global, ouvert à toutes les rédactrices :',
	...
	'info_envoi_forum' => 'Envoi des forums aux auteures des articles',
	...
	'info_option_email' => 'Lorsqu’une visiteuse du site poste un nouveau message dans le forum associé à un article, les auteures de l’article peuvent être prévenues de ce message par email. Indiquer pour chaque type de forum s’il faut utiliser cette option.',
	'info_pas_de_forum' => 'pas de forum',
	'info_question_visiteur_ajout_document_forum' => 'Si vous souhaitez autoriser les visiteuses à joindre des documents (images, sons…) à leurs messages de forum, indiquez ci-dessous la liste des extensions de documents autorisés pour les forums (ex : gif, jpg, png, mp3).',
	...
	'item_activer_forum_administrateur' => 'Activer le forum des administratrices',
	'item_config_forums_prive_global' => 'Activer le forum des rédactrices',
	'item_config_forums_prive_objets' => 'Activer ces forums',
	'item_desactiver_forum_administrateur' => 'Désactiver le forum des administratrices',
	'item_non_config_forums_prive_global' => 'Désactiver le forum des rédactrices',
	...
	'messages_meme_auteur' => 'Tous les messages de cette auteure',
	...
	'messages_privadm' => 'Administratrices',
	...
	'titre_cadre_forum_administrateur' => 'Forum privé des administratrices',
