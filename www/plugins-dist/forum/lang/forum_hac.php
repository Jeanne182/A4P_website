...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'forum_attention_trop_caracteres' => '<b>توجه!</b> پیامتان بسیار طولانی است     (@compte@کلمه)  و نباید از  @max@ کلمه بیشتر باشد.', # MODIF
	'forum_avez_selectionne' => ': شما انتخاب كرده ايد',
	'forum_cliquer_retour' => ' </a> اينجا <a href=\'@retour_forum@\'>     را براى ادامه كليك كنيد     ',
	'forum_forum' => 'سخنگاه',
	'forum_info_modere' => 'سخنگاه : پيامهاى شما پس از تأئيد گردانند گان سايت نمايان خواهند شد', # MODIF
	'forum_lien_hyper' => ' (اختيارى)  </b>پيوند هايپرتكست<b> ', # MODIF
	'forum_message_definitif' => 'پيام نهايى : به سايت بفرستيد',
	'forum_message_trop_long' => 'پيامتان بيش از حد بلند است. حداكثر اندازه ٢٠٠٠٠ حرف است', # MODIF
