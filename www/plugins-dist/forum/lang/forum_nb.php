...
// extrait automatiquement de https://trad.spip.net/tradlang_module/forum?lang_cible=nb
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
 ...
 administratorer slette dem).',
	...
	'forum_attention_trop_caracteres' => '<b>Advarsel !</b> meldinger er for lang (@compte@ tegn) : for at den skal kunne lagres må den ikke inneholde mer enn @max@ tegn.', # MODIF
	'forum_avez_selectionne' => 'Du har valgt:',
	'forum_cliquer_retour' => 'Klikk  <a href=\'@retour_forum@\'>her</a> for å fortsette.',
	'forum_forum' => 'forum',
	'forum_info_modere' => 'Dette forumet er overvåket: ditt innlegg vil vises etter å ha blitt sjekket av en administrator.', # MODIF
	'forum_lien_hyper' => '<b>Lenke</b> (valgfritt)', # MODIF
	'forum_message_definitif' => 'Siste melding: send til vev-sted',
	'forum_message_trop_long' => 'Meldingen er for lang. Maksimal lengde er 20000 tegn.', # MODIF
	...
	'forum_poste_par' => 'Melding kommet @parauteur@ til din artikkel "@titre@".', # MODIF
