...
// extrait automatiquement de https://trad.spip.net/tradlang_module/forum?lang_cible=en
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'bouton_radio_enregistrement_obligatoire' => 'Registration required (users must subscribe by providing their email address before being able to post contributions).',
	'bouton_radio_moderation_priori' => 'Pre-moderation (contributions will be shown only after validation by administrators).',
