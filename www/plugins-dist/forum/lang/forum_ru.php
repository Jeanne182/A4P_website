...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// A
	'aucun_message_forum' => 'Нет сообщений',
	...
	'forum_message_trop_long' => 'Вы превысили максимальный размер сообщение, оно должно быть не более 20000 символов.',
	...
	// I
	'icone_bruler_message' => 'Отметить как спам',
	'icone_bruler_messages' => 'Отметить как спам',
	...
	'icone_valider_messages' => 'Опубликовать на сайте',
	'icone_valider_repondre_message' => 'Опубликовать и ответить',
	'info_1_message_forum' => '1 сообщение',
	...
	'info_config_forums_prive' => 'В административной части сайта доступны следующие форумы:',
	'info_config_forums_prive_admin' => 'Форум для администраторов сайта:',
	'info_config_forums_prive_global' => 'Форум для всех авторов:',
...
',
	...
	// O
	'onglet_messages_internes' => 'Внутренние комментарии ',
	'onglet_messages_publics' => 'Комментарии на сайте',
	'onglet_messages_vide' => 'Комментарии без текста',
