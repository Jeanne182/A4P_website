...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// A
	'articles_dispo' => 'In der Warteschlange',
	'articles_meme_auteur' => 'Alle Artikel dieses Autors',
	'articles_off' => 'Blockiert',
	'articles_publie' => 'Veröffentlicht',
	'articles_refuse' => 'Gelöscht',
	'articles_tous' => 'Alle',
	'aucun_article_syndic' => 'Keine syndizierten Artikel vorhanden',
	...
	// C
	'confirmer_purger_syndication' => 'Wollen Sie wirklich alle syndizierten Artikel dieser Website löschen?',
	...
	'erreur_fichier_format_inconnu' => 'Das Format der Datei @fichier@ wird nicht verarbeitet.',
	'erreur_fichier_incorrect' => 'Datei kann nicht gelesen werden',

	// F
	'form_prop_nom_site' => 'Name der Website',

	// I
	'icone_article_syndic' => 'Syndizierter Artikel',
	'icone_articles_syndic' => 'Syndizierte Artikel',
	'icone_controler_syndication' => 'Veröffentlichung der syndizierten Artikel',
	'icone_modifier_site' => 'Website bearbeiten',
	'icone_referencer_nouveau_site' => 'Neue Website verlinken',
	'icone_site_reference' => 'Verlinkte Websites',
	'icone_supprimer_article' => 'Artikel löschen',
	'icone_supprimer_articles' => 'Diese Artikel löschen',
	...
	// L
	'label_exporter_avec_mots_cles_1' => 'Schlagworte als Tags exportieren',
	'label_exporter_id_parent' => 'Websites der Rubrik exportieren',
	'label_exporter_publie_seulement_1' => 'Nur freigeschaltete Websites exportieren',
	'label_fichier_import' => 'HTML-Datei',
	'label_importer_les_tags_1' => 'Tags als Schlagworte importieren',
	'label_importer_statut_publie_1' => 'Websites automatisch freischalten',
	'lien_mise_a_jour_syndication' => 'Jetzt aktualisieren',
	'lien_nouvelle_recuperation' => 'Abruf der Daten erneut versuchen',
	'lien_purger_syndication' => 'Alle syndizierten Artikel löschen',

	// N
	'nombre_articles_syndic' => '@nb@ syndizierte Artikel',

	// S
	'statut_off' => 'Gelöscht',
	'statut_prop' => 'In der Warteschlange',
	...
	// T
	'texte_expliquer_export_bookmarks' => 'Sie können eine Liste der Websites im HTML-Bookmark-Format exportieren, um sie anschließend in ihren Browser oder Bookmark-Service zu übernehmen.',
	'texte_expliquer_import_bookmarks' => 'Sie können eine Website-Liste im HTML-Bookmark-Format aus ihrem Webbrowser oder Bookmark-Service importieren.',
	...
	'texte_syndication' => 'Manche Websites ermöglichen den automatischen Abruf einer Liste von Neuigkeiten. Um diese Daten nutzen zu können, müssen Sie die Syndikation aktivieren.
	...
	'titre_exporter_bookmarks' => 'Bookmarks exportieren',
	'titre_importer_bookmarks' => 'Bookmarks importieren',
	'titre_importer_exporter_bookmarks' => 'Bookmarks exportieren und importieren',
	...
	'tout_voir' => 'Alle syndizierten Artikel anzeigen',

	// U
	'un_article_syndic' => '1 syndizierter Artikel'
);
