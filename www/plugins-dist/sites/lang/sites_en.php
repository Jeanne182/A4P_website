...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'texte_liens_sites_syndiques' => 'Links from syndicated sites can be held for moderation. Below is the default setting of syndicated sites on their creation. In any case, it is possible to release each link individually, or to choose to block all future links from a particular site.',
	...
	'texte_referencement_automatique' => '<b>Automated site referencing</b><br />You can reference a website quickly by indicating below its URL or the location of its syndication file. SPIP will automatically retrieve informations from that Web site (title, description etc.).',
	'texte_referencement_automatique_verifier' => 'Please verify the information provided by <tt>@url@</tt> before saving.',
	'texte_syndication' => 'If a site permits it, it is possible to retrieve the list of its latest articles automatically. To do this, you must activate syndication. 
