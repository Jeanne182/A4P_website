...
// extrait automatiquement de https://trad.spip.net/tradlang_module/sites?lang_cible=fr_tu
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// L
	'label_exporter_avec_mots_cles_1' => 'Exporter les mots-clés sous forme de tags',
	...
	// T
	'texte_expliquer_export_bookmarks' => 'Tu peux exporter une liste de sites au format Marque-page HTML, pour te permettre ensuite de l’importer dans ton navigateur ou dans un service en ligne',
	'texte_expliquer_import_bookmarks' => 'Tu peux importer une liste de sites au format Marque-page HTML, en provenance de ton navigateur ou d’un service en ligne de gestion des Marques-pages.',
	...
	'texte_syndication' => 'Il est possible de récupérer automatiquement, lorsqu’un site Web le permet, la liste de ses nouveautés. Pour cela, tu dois activer la syndication.
<blockquote><i>Certains hébergeurs désactivent cette fonctionnalité ; dans ce cas, tu ne pourras pas utiliser la syndication de contenu depuis ton site.</i></blockquote>',
	...
	'titre_importer_bookmarks' => 'Importer des Marques-pages',
	'titre_importer_exporter_bookmarks' => 'Importer et Exporter des Marques-pages',
