...
// extrait automatiquement de https://trad.spip.net/tradlang_module/sites?lang_cible=pt_br
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	// A
	'articles_dispo' => 'Na fila',
	'articles_meme_auteur' => 'Todas as matérias desse autor',
	'articles_off' => 'Bloqueadas',
	'articles_publie' => 'Publicadas',
	'articles_refuse' => 'Removidas',
	'articles_tous' => 'Todas',
	'aucun_article_syndic' => 'Nenhuma matéria sindicada',
	...
	// C
	'confirmer_purger_syndication' => 'Tem certeza de que quer remover todas as matérias sindicadas desse site?',
	...
	'erreur_fichier_format_inconnu' => 'O formato do arquivo @fichier@ não é suportado.',
	'erreur_fichier_incorrect' => 'Impossível ler o arquivo.',

	// F
	'form_prop_nom_site' => 'Nome do site',

	// I
	'icone_article_syndic' => 'Martéria sindicada',
	'icone_articles_syndic' => 'Matérias sindicadas',
	'icone_controler_syndication' => 'Publicação das matérias sindicadas',
	'icone_modifier_site' => 'Editar este site',
	'icone_referencer_nouveau_site' => 'Referenciar um novo site',
	'icone_site_reference' => 'Sites referenciados',
	'icone_supprimer_article' => 'Remover essa matéria',
	'icone_supprimer_articles' => 'Remover essas matérias',
	'icone_valider_article' => 'Validar essa matéria',
	'icone_valider_articles' => 'Validar essas matérias',
	'icone_voir_sites_references' => 'Ver os sites referenciados',
	'info_1_article_syndique' => '1 matéria sindicada',
	'info_1_site' => '1 site',
	'info_1_site_importe' => '1 site foi importado',
	'info_a_valider' => '[para validar]',
	'info_aucun_article_syndique' => 'Nenhuma matéria sindicada',
	'info_aucun_site' => 'Nenhum site',
	'info_aucun_site_importe' => 'Não foi possível importar nenhum site.',
	...
	'info_nb_sites_importes' => '@nb@ sites foram importados',
	...
	// L
	'label_exporter_avec_mots_cles_1' => 'Exportar palavras-chave na forma de tags',
	'label_exporter_id_parent' => 'Exportar os sites da seção',
	'label_exporter_publie_seulement_1' => 'Exportar somente os sites publicados',
	'label_fichier_import' => 'Arquivo HTML',
	'label_importer_les_tags_1' => 'Importar tags na forma de palavras-chave',
	'label_importer_statut_publie_1' => 'Publicar automaticamente os sites',
	'lien_mise_a_jour_syndication' => 'Atualizar agora',
	'lien_nouvelle_recuperation' => 'Tentar uma nova recuperação dos dados',
	'lien_purger_syndication' => 'Excluir todas as matérias sindicadas',

	// N
	'nombre_articles_syndic' => '@nb@ artigos sindicados',
	...
	// T
	'texte_expliquer_export_bookmarks' => 'Você pode exportar uma lista de sites no formato bookmark HTML, para permitir de importá-la em seu navigador ou em um serviço on line',
	'texte_expliquer_import_bookmarks' => 'Você pode importar uma lista de sites no formato bookmark HTML, a partir de seu navegador ou de um serviço on line de gerenciamento de bookmarks.',
	'texte_liens_sites_syndiques' => 'Os links gerados pelos sites sindicados podem ser bloqueados previamente; a configuração abaixo indica a opção padrão para os sites sindicados, após sua inclusão. É possível, em seguida, desbloquear cada link individualmente, ou escolher, site a site, o bloqueio de links originados de um ou outro site.',
...
<blockquote><i>Alguns serviços de hospedagem desativam esta funcionalidade; neste caso, você não poderá usar a sindicação de conteúdo no seu site.</i></blockquote>',
	...
	'titre_exporter_bookmarks' => 'Exportar bookmarks',
	'titre_importer_bookmarks' => 'Importar bookmarks',
	'titre_importer_exporter_bookmarks' => 'Importar e exportar bookmarks',
	...
	'tout_voir' => 'Ver todas as matérias sindicadas',

	// U
	'un_article_syndic' => '1 matéria sindicada'
);
