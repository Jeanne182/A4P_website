...
include_once_check(_ROOT_PLUGINS.'auto/pages/v1.5.2/pages_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/saisies/v3.42.2/saisies_pipelines.php');
$inc=true;
}
$val = minipipe('cvtmulti_styliser', $val);
$val = minipipe('vertebres_styliser', $val);
$val = minipipe('pages_styliser', $val);
...
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/couteau_suisse/v1.10.19/cout_pipelines.php');
$inc=true;
}
...
include_once_check(_ROOT_PLUGINS.'crayons/crayons_fonctions.php');
include_once_check(_ROOT_PLUGINS.'auto/couteau_suisse/v1.10.19/cout_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/saisies/v3.42.2/saisies_pipelines.php');
include_once_check(_ROOT_PLUGINS.'jeux/jeux_pipelines.php');
$inc=true;
}
...
$val = minipipe('crayons_affichage_final', $val);
...
$val = minipipe('jeux_affichage_final', $val);
return $val;
}
...
if (!$inc){
include_once_check(_ROOT_PLUGINS_DIST.'forum/forum_pipelines.php');
include_once_check(_ROOT_PLUGINS.'engagements/petitions_pipelines.php');
$inc=true;
}
...
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'gis/gis_pipelines.php');
$inc=true;
}
$val = minipipe('gis_afficher_contenu_objet', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'organiseur/organiseur_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/couteau_suisse/v1.10.19/cout_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/formidable/v4.5.3/formidable_pipelines.php');
$inc=true;
}
...
$val = minipipe('formidable_affiche_droite', $val);
return $val;
}
...
$val = minipipe('jeux_affiche_gauche', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'medias/medias_pipelines.php');
include_once_check(_ROOT_PLUGINS.'pays/pays_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/formidable/v4.5.3/formidable_pipelines.php');
$inc=true;
}
...
$val = minipipe('pages_affiche_milieu_ajouter_page', $val);
$val = minipipe('pages_affiche_milieu_identifiant', $val);
...
$val = minipipe('formidable_affiche_milieu', $val);
return $val;
}
...
$val = minipipe('pages_affiche_hierarchie', $val);
return $val;
}
...
$val = minipipe('couteau_suisse_arbo_creer_chaine_url', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'urls_etendues/urls_pipeline.php');
include_once_check(_ROOT_PLUGINS.'engagements/petitions_autoriser.php');
include_once_check(_ROOT_PLUGINS.'auto/pages/v1.5.2/pages_autorisations.php');
...
include_once_check(_ROOT_PLUGINS.'pays/pays_autorisations.php');
include_once_check(_ROOT_PLUGINS.'gis/gis_autoriser.php');
include_once_check(_ROOT_PLUGINS.'auto/formidable/v4.5.3/formidable_autorisations.php');
include_once_check(_ROOT_PLUGINS.'jeux/jeux_autorisations.php');
$inc=true;
}
...
$val = minipipe('pages_boite_infos', $val);
...
include_once_check(_ROOT_PLUGINS.'engagements/base/petitions.php');
include_once_check(_ROOT_PLUGINS.'auto/couteau_suisse/v1.10.19/cout_pipelines.php');
include_once_check(_ROOT_PLUGINS_DIST.'breves/base/breves.php');
include_once_check(_ROOT_PLUGINS_DIST.'medias/base/medias.php');
include_once_check(_ROOT_PLUGINS.'pays/base/pays.php');
include_once_check(_ROOT_PLUGINS.'gis/base/gis.php');
include_once_check(_ROOT_PLUGINS.'auto/formidable/v4.5.3/base/formidable_tables.php');
include_once_check(_ROOT_PLUGINS.'jeux/base/jeux_tables.php');
$inc=true;
}
...
$val = minipipe('gis_declarer_tables_interfaces', $val);
$val = minipipe('formidable_declarer_tables_interfaces', $val);
$val = minipipe('jeux_declarer_tables_interfaces', $val);
return $val;
}
...
include_once_check(_ROOT_PLUGINS_DIST.'svp/base/svp_declarer.php');
include_once_check(_ROOT_PLUGINS.'engagements/base/petitions.php');
include_once_check(_ROOT_PLUGINS.'auto/pages/v1.5.2/base/pages_tables.php');
include_once_check(_ROOT_PLUGINS_DIST.'breves/base/breves.php');
include_once_check(_ROOT_PLUGINS_DIST.'medias/base/medias.php');
include_once_check(_ROOT_PLUGINS.'pays/base/pays.php');
include_once_check(_ROOT_PLUGINS.'gis/base/gis.php');
...
$val = minipipe('pages_declarer_tables_objets_sql', $val);
...
$val = minipipe('gis_declarer_tables_objets_sql', $val);
$val = minipipe('formidable_declarer_tables_objets_sql', $val);
$val = minipipe('jeux_declarer_tables_objets_sql', $val);
return $val;
}
...
$val = minipipe('jeux_declarer_tables_principales', $val);
return $val;
}
...
$val = minipipe('gis_declarer_tables_auxiliaires', $val);
...
$val = minipipe('pages_editer_contenu_objet', $val);
return $val;
}
// Pipeline exec_init 
...
include_once_check(_ROOT_PLUGINS_DIST.'revisions/inc/revisions_pipeline.php');
include_once_check(_ROOT_PLUGINS.'auto/pages/v1.5.2/pages_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/nospam/v2.1.6/nospam_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/saisies/v3.42.2/saisies_pipelines.php');
$inc=true;
}
...
$val = minipipe('pages_formulaire_charger', $val);
$val = minipipe('nospam_formulaire_charger', $val);
...
$val = minipipe('pages_formulaire_verifier', $val);
$val = minipipe('nospam_formulaire_verifier', $val);
...
$val = minipipe('gis_formulaire_traiter', $val);
return $val;
}
...
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/nospam/v2.1.6/nospam_pipelines.php');
include_once_check(_ROOT_PLUGINS.'auto/facteur/v4.0.4/facteur_fonctions.php');
$inc=true;
}
$val = minipipe('nospam_formulaire_fond', $val);
...
$val = minipipe('crayons_insert_head', $val);
...
$val = minipipe('gis_header_prive', $val);
$val = minipipe('jeux_header_prive', $val);
return $val;
}
...
$val = minipipe('gis_insert_head', $val);
$val = minipipe('jeux_insert_head', $val);
return $val;
}
...
$val = minipipe('couteau_suisse_insert_head_css', $val);
$val = minipipe('gis_insert_head_css', $val);
return $val;
}
...
$val = minipipe('gis_libeller_logo', $val);
return $val;
}
...
$val = minipipe('pays_optimiser_base_disparus', $val);
$val = minipipe('gis_optimiser_base_disparus', $val);
$val = minipipe('formidable_optimiser_base_disparus', $val);
$val = minipipe('jeux_optimiser_base_disparus', $val);
return $val;
}
...
$val = minipipe('pages_pre_boucle', $val);
return $val;
}
...
$val = minipipe('jeux_pre_propre', $val);
return $val;
}
// Pipeline pre_liens 
...
$val = minipipe('jeux_post_propre', $val);
return $val;
}
// Pipeline pre_typo 
...
$val = minipipe('pages_pre_edition_ajouter_page', $val);
$val = minipipe('nospam_pre_edition', $val);
return $val;
}
...
$val = minipipe('gis_post_edition', $val);
$val = minipipe('formidable_post_edition', $val);
return $val;
}
...
$val = minipipe('couteau_suisse_propres_creer_chaine_url', $val);
return $val;
}
...
$val = minipipe('formidable_taches_generales_cron', $val);
return $val;
}
...
$val = minipipe('couteau_suisse_recuperer_fond', $val);
return $val;
}
// Pipeline traduire 
...
include_once_check(_ROOT_PLUGINS.'auto/facteur/v4.0.4/facteur_ieconfig_metas.php');
...
$val = minipipe('formidable_crayons_controleur', $val);
return $val;
}
...
$val = minipipe('formidable_crayons_verifier', $val);
return $val;
}
// Pipeline crayons_vue_affichage_final 
function execute_pipeline_crayons_vue_affichage_final(&$val){
return $val;
}
...
// Pipeline pages_uniques_utiles 
function execute_pipeline_pages_uniques_utiles(&$val){
return $val;
}
...
$val = minipipe('formidable_nospam_lister_formulaires', $val);
return $val;
}
...
$val = minipipe('gis_saisies_autonomes', $val);
return $val;
}
// Pipeline saisie_est_tabulaire 
function execute_pipeline_saisie_est_tabulaire(&$val){
return $val;
}
// Pipeline saisies_afficher_si_js_type 
function execute_pipeline_saisies_afficher_si_js_type(&$val){
$val = minipipe('saisies_saisies_afficher_si_js_type', $val);
return $val;
}
// Pipeline saisies_lister_disponibles 
...
function execute_pipeline_saisies_verifier(&$val){
return $val;
}
// Pipeline saisies_afficher_si_js_saisies_form 
function execute_pipeline_saisies_afficher_si_js_saisies_form(&$val){
return $val;
}
// Pipeline gis_modele_parametres_autorises 
function execute_pipeline_gis_modele_parametres_autorises(&$val){
$val = minipipe('gis_gis_modele_parametres_autorises', $val);
return $val;
}
// Pipeline xmlrpc_methodes 
function execute_pipeline_xmlrpc_methodes(&$val){
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'gis/gis_pipelines.php');
$inc=true;
}
$val = minipipe('gis_xmlrpc_methodes', $val);
return $val;
}
// Pipeline xmlrpc_server_class 
function execute_pipeline_xmlrpc_server_class(&$val){
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'gis/gis_pipelines.php');
$inc=true;
}
$val = minipipe('gis_xmlrpc_server_class', $val);
return $val;
}
// Pipeline formidable_affiche_resume_reponse 
function execute_pipeline_formidable_affiche_resume_reponse(&$val){
return $val;
}
// Pipeline formidable_parametres_accuse 
function execute_pipeline_formidable_parametres_accuse(&$val){
return $val;
}
// Pipeline formidable_exporter_formulaire_reponses_titres 
function execute_pipeline_formidable_exporter_formulaire_reponses_titres(&$val){
return $val;
}
// Pipeline formidable_exporter_formulaire_reponses_reponse 
function execute_pipeline_formidable_exporter_formulaire_reponses_reponse(&$val){
return $val;
}
// Pipeline formidable_traiter_email_destinataires 
function execute_pipeline_formidable_traiter_email_destinataires(&$val){
return $val;
}
// Pipeline formidable_traitements 
function execute_pipeline_formidable_traitements(&$val){
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/formidable/v4.5.3/formidable_pipelines.php');
$inc=true;
}
$val = minipipe('formidable_formidable_traitements', $val);
return $val;
}
// Pipeline corbeille_table_infos 
function execute_pipeline_corbeille_table_infos(&$val){
static $inc=null;
if (!$inc){
include_once_check(_ROOT_PLUGINS.'auto/formidable/v4.5.3/formidable_pipelines.php');
$inc=true;
}
$val = minipipe('formidable_corbeille_table_infos', $val);
return $val;
}
// Pipeline jeux_caracteristiques 
function execute_pipeline_jeux_caracteristiques(&$val){
return $val;
}
