...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'avis_deplacement_rubrique' => 'LET OP! Deze rubriek bevat @contient_breves@ nieuwsbericht@scb@. Als je wil verplaatsten, bevestig dit dan door hier het vakje aan te vinken.',
	'avis_erreur_connexion_mysql' => 'Verbinding met de SQL connectie mislukt',
	'avis_espace_interdit' => '<b>Toegang verboden</b><div>SPIP is al geïnstalleerd.',
	...
	'config_info_base_sup' => 'Als u andere databases hebt om door SPIP te ondervragen, met zijn SQL server of anders, kan je deze via onderstaand formulier opgeven. Als u bepaalde velden leeg laat, zullen de identificatiegegevens van de primaire database gebruikt worden.',
	...
	'config_info_logos_utiliser_non' => 'De logo’s niet gebruiken',
	'config_info_logos_utiliser_survol' => 'De zwevende logo’s gebruiken',
	...
	'entree_adresse_email_2' => 'E-mail adres',
	...
	'erreur_plugin_prefix_manquant' => 'Ruimte van plugin naam is niet gedefinieerd',
	...
	'ical_texte_prive' => 'Deze kalender is voor persoonlijk gebruik en houdt je op de hoogte van je eigen editoriale activiteit (taken en persoonlijke afspraken, voorgestelde artikelen en nieuwsberichten...).',
	'ical_texte_public' => 'Via deze kalender kan je de publieke activiteit van de site volgen (gepubliceerde artikelen en nieuwsberichten).',
...
',
	...
	'info_config_suivi_explication' => 'Je kan je op de mailinglijst van deze site inschrijven. Je zal dan via e-mail een aankondiging ontvangen van artikelen en nieuwsberichten die voor publicatie werden voorgesteld.',
...
gewiste auteurs met een grijze.',
 ...
 publieke site vinden (forums met inschrijving).',
	...
	'info_login_trop_court_car_pluriel' => 'De login moet minstens @nb@ tekens.',
	...
	'info_modification_enregistree' => 'Uw wijziging werd geregistreerd',
...
',
   ...
   (recent gepubliceerde artikelen en nieuwsberichten).',
	...
	'info_procedure_maj_version' => 'de procedure voor de update die nodig is om de database aan te passen
 ...
 niet mogelijk.</div>',
	...
	'info_redirection_activee' => 'De omleiding is ingeschakeld.',
	'info_redirection_boucle' => 'Je probeert het artikel op zichzelf te redirigeren.',
	'info_redirection_desactivee' => 'De redirect is verwijderd.',
	'info_refuses' => 'Uw geweigerde artikelen',
	...
	'info_syndication_integrale_1' => 'Uw site stelt syndicatiebestanden voor (zie « <a href="@url@">@titre@</a> »).',
	'info_syndication_integrale_2' => 'Wil u integrale artikelen doorgeven of enkel een samenvatting van enkele honderden karakters doorgeven ?',
...
een kleur geeft hun status aan :',
	...
	'install_serveur_hebergeur' => 'Databaseserver die door de leverancier wordt toegekend',
	'install_table_prefix_hebergeur' => 'Het voorvoegsel van de tabel dat door de leverancier wordt toegekend:',
	...
	'item_non_messagerie_agenda' => 'De berichtendienst en de agenda desactiveren',
	...
	'plugin_charge_paquet' => 'Lading van het pakket @name@',
	...
	'plugin_necessite_php' => 'Benodigt @plugin@ in versie @version@.',
	...
	'plugin_zip_installe_rep_finie' => 'Het bestand @zip@ is geunzipt en werd in de lijst @rep@ geplaatst',
	'plugin_zip_installer' => 'Je kunt nu het nu plaatsen.',
	...
	'queue_info_purger' => 'Je kunt alle wachtende taken verwijderen en het lijst van periodieke taken herstarten',
...
inbegrepen <i>alle</i> toegangsrechten voor redacteurs en beheerders. Nadat je dit uitgevoerd hebt, dien je de herinstallatie van SPIP te starten om een volledig nieuwe database aan te maken met toegangsrechten voor een eerste beheerder.',
	...
	'texte_choix_base_3' => '<b>Kies</b> hierna die welke door jouw leverancier werd toegekend:',
	...
	'texte_connexion_mysql' => 'Raadpleegt de inlichtingen die door jouw leverancier worden verstrekt: je moet er de databaseserver vinden die men voorstelt en jouw persoonlijke identificaties om je erop aan te melden.',
...
Als dit geen geen nut heeft, kunt je de standaard instellingen behouden (geen nieuw bestand maken).</p>',
 ...
 eveneens de database te updaten.',
	...
	'texte_proposer_publication' => 'Wanneer uw artikel wordt beëindigd, <br /> kunt u zijn publicatie voorstellen.',
...
Dit kan handig zijn als je veel pagina’s hebt gewijzigd, de layout of de structuur van de site hebt veranderd.
 ...
 scherm verschijnen.',
	...
	'titre_configurer_preferences' => 'Configureer uw voorkeuren',
